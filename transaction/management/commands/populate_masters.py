...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        branch2 = BranchMaster.objects.create(short_name="MOON", contact_person_name="Suresh",
                                              ...
                                              gst_number="24AAFFG8339R1ZQ")
        department1 = DepartmentMaster.objects.create(depname="Warp Knitting")
        department2 = DepartmentMaster.objects.create(depname="DPV")

        company1 = CompanyLedgerMaster.objects.create(
            comname="Ace", gst_number="23453554", supplier_status=True, address1="4325 Bahubali Nagar", pin_code="123456",
            mobile=9864596945)

        article_1 = ArticleMaster.objects.create(articlename='YarnArticle1', short_name='YA1', blend_pct="CT50PY50",
                                                 twists=50)
        ...
        article_2 = ArticleMaster.objects.create(articlename='YarnArticle2', short_name='YA2',
